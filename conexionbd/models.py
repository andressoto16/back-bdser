...
class IfRepartoGralPte1(models.Model):
    ...
    pen_idsolpadre = models.DecimalField(db_column='pen_idSolPadre', max_digits=12, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    pen_fchcargue = models.DateField()
    re_diso_001 = models.DecimalField(db_column='RE_DISO_001', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_meso_002 = models.DecimalField(db_column='RE_MESO_002', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_anso_003 = models.DecimalField(db_column='RE_ANSO_003', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_hoso_087 = models.DecimalField(db_column='RE_HOSO_087', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_miso_088 = models.DecimalField(db_column='RE_MISO_088', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_deso_004 = models.DecimalField(db_column='RE_DESO_004', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_muso_005 = models.DecimalField(db_column='RE_MUSO_005', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_enso_006 = models.CharField(max_length=1000,db_column='RE_ENSO_006', blank=True, null=True)  # Field name made lowercase.
    re_ortr_009 = models.DecimalField(db_column='RE_ORTR_009', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_dire_008 = models.CharField(max_length=1000,db_column='RE_DIRE_008', blank=True, null=True)  # Field name made lowercase.
    re_dire_009 = models.DecimalField(db_column='RE_DIRE_009', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_mere_010 = models.DecimalField(db_column='RE_MERE_010', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_anre_011 = models.DecimalField(db_column='RE_ANRE_011', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_hore_089 = models.DecimalField(db_column='RE_HORE_089', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_mire_090 = models.DecimalField(db_column='RE_MIRE_090', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_tiev_015 = models.DecimalField(db_column='RE_TIEV_015', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_niev_016 = models.CharField(max_length=1000,db_column='RE_NIEV_016', blank=True, null=True)  # Field name made lowercase.
    re_seev_021 = models.DecimalField(db_column='RE_SEEV_021', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    re_grpo_022 = models.DecimalField(db_column='RE_GRPO_022', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grdp_023 = models.DecimalField(db_column='RE_GRDP_023', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grvd_035 = models.DecimalField(db_column='RE_GRVD_035', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grdi_024 = models.DecimalField(db_column='RE_GRDI_024', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grsp_036 = models.DecimalField(db_column='RE_GRSP_036', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grco_025 = models.DecimalField(db_column='RE_GRCO_025', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_gres_037 = models.DecimalField(db_column='RE_GRES_037', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_gros_026 = models.DecimalField(db_column='RE_GROS_026', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grde_038 = models.DecimalField(db_column='RE_GRDE_038', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grsi_027 = models.DecimalField(db_column='RE_GRSI_027', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grup_039 = models.DecimalField(db_column='RE_GRUP_039', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grog_028 = models.DecimalField(db_column='RE_GROG_028', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grad_040 = models.DecimalField(db_column='RE_GRAD_040', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grge_029 = models.DecimalField(db_column='RE_GRGE_029', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grdo_041 = models.DecimalField(db_column='RE_GRDO_041', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grmm_030 = models.DecimalField(db_column='RE_GRMM_030', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_gros_042 = models.DecimalField(db_column='RE_GROS_042', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grtd_031 = models.DecimalField(db_column='RE_GRTD_031', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grda_043 = models.DecimalField(db_column='RE_GRDA_043', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grpd_032 = models.DecimalField(db_column='RE_GRPD_032', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grfd_044 = models.DecimalField(db_column='RE_GRFD_044', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grip_033 = models.DecimalField(db_column='RE_GRIP_033', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grcc_045 = models.DecimalField(db_column='RE_GRCC_045', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_cope_034 = models.DecimalField(db_column='RE_COPE_034', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    re_maca_048 = models.DecimalField(db_column='RE_MACA_048', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_pete_054 = models.DecimalField(db_column='RE_PETE_054', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_viud_049 = models.DecimalField(db_column='RE_VIUD_049', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_pedi_055 = models.DecimalField(db_column='RE_PEDI_055', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_gest_050 = models.DecimalField(db_column='RE_GEST_050', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_lgtb_056 = models.DecimalField(db_column='RE_LGTB_056', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_lact_051 = models.DecimalField(db_column='RE_LACT_051', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_afro_057 = models.DecimalField(db_column='RE_AFRO_057', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_mame_052 = models.DecimalField(db_column='RE_MAME_052', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_indi_058 = models.DecimalField(db_column='RE_INDI_058', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_home_053 = models.DecimalField(db_column='RE_HOME_053', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_nsnr_059 = models.DecimalField(db_column='RE_NSNR_059', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_obse_060 = models.CharField(max_length=1000,db_column='RE_OBSE_060', blank=True, null=True)  # Field name made lowercase.
    re_deri_061 = models.DecimalField(db_column='RE_DERI_061', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_muri_062 = models.DecimalField(db_column='RE_MURI_062', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    re_dere_065 = models.DecimalField(db_column='RE_DERE_065', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_mure_066 = models.DecimalField(db_column='RE_MURE_066', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    re_depc_071 = models.DecimalField(db_column='RE_DEPC_071', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_mupc_072 = models.DecimalField(db_column='RE_MUPC_072', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_dipc_073 = models.CharField(max_length=1000,db_column='RE_DIPC_073', blank=True, null=True)  # Field name made lowercase.
    re_teri_074 = models.DecimalField(db_column='RE_TERI_074', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_nufo_075 = models.DecimalField(db_column='RE_NUFO_075', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_tire_076 = models.DecimalField(db_column='RE_TIRE_076', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_tide_078 = models.DecimalField(db_column='RE_TIDE_078', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_tisp_077 = models.DecimalField(db_column='RE_TISP_077', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_tiot_079 = models.DecimalField(db_column='RE_TIOT_079', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_diot_012 = models.DecimalField(db_column='RE_DIOT_012', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_meot_013 = models.DecimalField(db_column='RE_MEOT_013', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_anot_014 = models.DecimalField(db_column='RE_ANOT_014', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_hoot_092 = models.DecimalField(db_column='RE_HOOT_092', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_miot_093 = models.DecimalField(db_column='RE_MIOT_093', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_sere_094 = models.DecimalField(db_column='RE_SERE_094', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_asno_083 = models.DecimalField(db_column='RE_ASNO_083', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_fuau_084 = models.DecimalField(db_column='RE_FUAU_084', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    re_categoria = models.DecimalField(db_column='RE_CATEGORIA', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    re_grpo_022_historico = models.DecimalField(db_column='RE_GRPO_022_HISTORICO', max_digits=5, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    cuf_int_sispro = models.CharField(max_length=1000,blank=True, null=True)
